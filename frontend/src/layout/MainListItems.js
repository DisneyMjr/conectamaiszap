  ...
  return (
    <li>
      <ListItem 
        ...
        className={className}
        style={{ 
          padding: '12px 16px',  // Aumenta o padding para melhor toque
          minHeight: '48px'      // Altura mínima para garantir área de toque
        }}
      >
        {icon ? (
        ...
        <ListItemText 
          ...
          style={{ 
            margin: 0,
            '& span': {
              fontSize: '15px'  // Tamanho de fonte adequado para mobile
            }
          }} 
        />
      </ListItem>
